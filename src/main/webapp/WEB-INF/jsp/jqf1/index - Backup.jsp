...
<div id="divHeader" style="clear:both;">
  <h1 style="font:bold 16px arial;padding:10px;width:400px;margin:10px 0px;">JQF1 - Jquery FormOne - Jquery Form Styling plugin</h1>
  <ul class="ul idiomas" style="font: bold 14px arial;">
    <li>Langs:</li>
    <li><a href="index.html" style="padding:10px;">English version</a></li>
    <li><a href="portugues.html" style="padding:10px;">Vers&atilde;o em portugu&ecirc;s</a></li>
  </ul>
  <ul class="ul" style="font: bold 14px arial;">
    <li>Download:</li>
    <li><a href="http://bit.ly/jqf1zip" style="padding:10px;">JQF1 1.0.3 (jqf1.zip)</a></li>
    <li>Author: <em>Thiago Azur&eacute;m (azurem@gmail.com)</em></li>
  </ul>
</div>

<div id="rotate" style="float:left;width:565px;margin:15px 0px;border-bottom:1px solid silver;">
            <ul>
                <li><a href="#tabz0"><span>All/Tudo</span></a></li>
                <li><a href="#tabz1"><span>Input&nbsp;text</span></a></li>
...
<div style="padding:10px;">
    <ul class="ul">
      <li><label for="inp1">Input text:</label></li>
      <li><input type="text" id="inp1" size="12" name="inp1" maxlength="10" /></li>
    </ul>
    <ul class="ul">
      <li><label for="inprad1">Input radio 1:</label></li>
      <li><input type="radio" id="inprad1" name="inprad" value="rad01" /></li>
      <li><label for="inprad2">Input radio 2:</label></li>
      <li><input type="radio" id="inprad2" name="inprad" value="rad02" checked /></li>
    </ul>
    <ul class="ul">
      <li><label for="inpche1">Input check 1:</label></li>
      <li><input type="checkbox" id="inpche1" name="inpche" value="ck01" /></li>
      <li><label for="inpche2">Input check 2:</label></li>
      <li><input type="checkbox" id="inpche2" name="inpche" value="ck02" /></li>
    </ul>
    <ul class="ul">
      <li><label for="inpF">Input file:</label></li>
      <li><input type="file" id="inpF"  name="inpF" style="width:300px;" /></li>
    </ul>
    <ul class="ul">
      <li><label for="selIgnored">Select jqf1=ok:</label></li>
      <li>
        <select name="selIgnored" id="selIgnored" jqf1="ok">
          <option value="01">Option 1</option>
          <option value="02">Option 2</option>
          <option value="03">Option 3</option>
        </select>
      </li>
      <li style="padding:3px 0px 0px 5px;">(Ignored element || Elemento ignorado)</li>
    </ul>
    <ul class="ul">
      <li><label for="selNormal">Select:</label></li>
      <li>
        <select name="selNormal" id="selNormal">
            <option value="01">Option 1</option>
            <option value="02">Option 2</option>
            <option value="03">Option 3</option>
    ...
    <ul class="ul">
      <li><label for="selectG">Multiple with optgroup:</label></li>
      <li>
        <select name="selectG" id="selectG" multiple="multiple" style="width:200px;">
    ...
    <ul class="ul">
      <li><label for="selectSz">Multiple size=1:</label></li>
      <li>
        <select name="selectSz" id="selectSz" multiple="multiple" size="1" style="width:150px;" openheight="100">
    ...
    <ul class="ul">
      <li><label for="textA">Textarea:</label></li>
      <li><textarea id="textA" rows="3" cols="40" style="width:400px" name="textA"></textarea></li>
    </ul>
    <ul class="ul">
      <li><label for="selectS">Select Search:</label></li>
      <li>
        <select name="selectS" id="selectS" search="ok" openheight="150">
...
<div class="divIntroducao" id="divEnus" style="font:12px arial;width:400px;float:left;padding:10px;margin:15px 0px 10px 10px;border:1px solid silver;background-color:#FCFEDA">
  <p><b>JQF1 is the most complete form styling JQuery plugin</b>, read some features below:</p>
  <ol>
    <li>Crossbrowser: Tested in IE 6,7,8, Firefox(win/mac), Safari(win/mac), Opera, Chrome, SeaMonkey, Flock (Please report the bugs to azurem@gmail.com with browser, version, O.S. information and a printscreen/screenshot).</li>
    <li>Keeps working events and some attributes:: label for, onclicks, onchanges, etc...</li>
    <li>The style be created using the original form element sizes, keeps the same layout with or without javascript.</li>
    <li>Uses the original elements all the time. It's easy to working with AJAX.</li>
    <li>Exclusive feature: search filter inside of select options list.</li>
    <li>Exclusive feature: Select multiple with attribute size=1 works like a normal select, but uses a checkbox elements inside to apply the multiple options :)</li>
  </ol>
  <div style="font:11px arial;">
    <p style="color:green"><b>08/09/2010 - CRITICAL BUG SOLVED: Updating select / Adding select with DOM - 1.0.3</b></p>
    <p style="color:green"><b>21/08/2010 - Bugs solved: Selects hidding like as original, type=reset ok (Sorry, I forgot :P Thanks Nickson!) - 1.0.2</b></p>
    <p style="color:green"><b>07/06/2010 - Bugs solved: Select active option status ok (font-size and standard width)  - 1.0.111</b></p>
    <p style="color:green"><b>06/06/2010 - CRITICAL BUG SOLVED: option selection bug (bug from 1.0.101 version) =) - 1.0.110</b></p>
    <p style="color:green"><b>05/06/2010 - Bugs solved: Select (width optgroup) search and manipulation bugs! =) - 1.0.101</b></p>
    <p style="color:green"><b>05/06/2010 - Optgroup now works! =) - 1.0.1</b></p>
    <p style="color:green"><b>07/03/2010 - All buttons widths bugs and IE7 textarea bug solved! :) - 1.0.082</b></p>
    <p style="color:green"><b>06/01/2010 - CRTICAL BUG SOLVED: input password now transforms (LOL :P) - 1.0.081</b></p>
    <p style="color:green"><b>17/12/2009 - Usability enhancement: Radios/Checks (All browsers) works as usual and select(IE/Firefox) opens ONFOCUS (tab navigation) - 1.0.07</b></p>
    <p style="color:green"><b>17/12/2009 - Hidden elements are disabled to transform onload - 1.0.06</b></p>
    <p style="color:green"><b>14/12/2009 - CRTICAL BUG SOLVED: Buttons overlap - 1.0.05</b></p>
    <p style="color:green"><b>14/12/2009 - Bug solved: SAFARI select area calculator - 1.0.04</b></p>
    <p style="color:green"><b>13/12/2009 - Bug solved: CSS bugs,select area calculator for portuguese version, button area calculator - 1.0.03</b></p>
    <p style="color:green"><b>28/11/2009 - Bug solved: select search filter style bug - 1.0.02</b></p>
    <p style="color:green"><b>27/11/2009 - Bug solved: checkbox/radio JS manipulation - 1.0.01</b></p>
  </div>
</div>
