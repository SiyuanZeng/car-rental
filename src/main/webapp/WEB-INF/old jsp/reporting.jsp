...
<table>
	...
	<tr>
		<td>Booked To</td>
		<td><input type="text" name="booked_to"  onblur="fnGetTotalRent(this.form)"></input></td>
	</tr>
	<tr>
		<td>Total Rent</td>
		<td>
		<div id="rent"><input type="text" name="total_rent"
			id="total_rent"></input></div>
